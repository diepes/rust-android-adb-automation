        ...
        for entry in entries.flatten() {
                ...
                && metadata.is_file()
            {
                ...
                if let Some(filename) = path.file_name() {
                    ...
                    if (filename_str.starts_with("patch-") || filename_str.starts_with("patch_"))
                ...
                if let Some(filename) = path.file_name() {
                    ...
                    if filename_str.starts_with("img-") && filename_str.ends_with(".png") {
                            ...
                            extract_region_and_label_from_filename(&source_path)
                        {
                            ...
                            println!(
                                "  Extracted region: x={}, y={}, width={}, height={}",
                                x, y, width, height
                            );
                            ...
                            match image::open(&source_path) {
                                Ok(img) => {
                                    ...
                                    println!(
                                        "  Source dimensions: {}x{} (loaded in {:.2}ms)",
                                        img.width(),
                                        img.height(),
                                    ...
                                    if x + width > img.width() || y + height > img.height() {
                                        eprintln!(
                                            "  ✗ Error: Region [{}..{}] × [{}..{}] exceeds image bounds [{}x{}]",
                                            x,
                                            x + width,
                                            y,
                                            y + height,
                                        ...
                                        match cropped.save(&output_path) {
                                            Ok(_) => {
                                                ...
                                                println!(
                                                    "  ✓ Saved patch to: {} (crop: {:.2}ms, save: {:.2}ms, total: {:.2}ms)",
...
mod tests {
    ...
    fn test_generate_output_path() {
        let path =
            generate_output_path("assets/test_images/screenshot.png", None, 100, 200, 50, 50);
    ...
    fn test_extract_region_and_label_from_filename() {
        ...
        let region = extract_region_and_label_from_filename(
            "assets/test_images/img-dialog-[10,20,100,100].png",
        );
        ...
        let region =
            extract_region_and_label_from_filename("img-label-[ 550 , 1345 , 500 , 200 ].png");
        assert_eq!(
            region,
